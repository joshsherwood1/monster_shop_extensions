...
describe "Admin can see all orders" do
  before :each do
    ...
    @admin = User.create(name: 'Christopher', email: 'christopher7895@email.com', password: 'p@ssw0rd', role: 3)
    ...
    @address_3 = @user_2.addresses.create(address: "234 Main", city: "Denver", state: "CO", zip: 80204)
    @address_4 = @user_1.addresses.create(address: "234 Main", city: "Denver", state: "CO", zip: 80204)
    @order_2 = @user_2.orders.create!( address_id: @address_4.id, status: 0)
    @order_5 = @user_2.orders.create!( address_id: @address_4.id, status: 3)
    @order_3 = @user_2.orders.create!( address_id: @address_4.id, status: 1)
    @order_4 = @user_1.orders.create!( address_id: @address_3.id, status: 2)
    @order_1 = @user_1.orders.create!( address_id: @address_3.id, status: 0)
